    ...
    const prompt =
      buildPrompt(
        ...
        [
          ...
          "Analiza el puesto al que se postula y relaciona con las habilidades",
...
[habilidad original]: [mejora]`;
    ...
    const suggestedSection =
      sections.find((section) => section.includes("SUGERIDAS:")) || "";
    const improvementsSection =
      sections.find((section) => section.includes("MEJORAS:")) || "";
    ...
    const improvements = improvementLines.reduce(
      (acc: { [key: string]: string }, line: string) => {
