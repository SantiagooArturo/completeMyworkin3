...
const HarvardVolunteerGuide = () => {
  return (
    <div className="bg-green-50 border border-green-200 rounded-lg p-4 mt-4">
      <h4 className="font-medium text-green-900 mb-2">🎓 Formato Harvard - Voluntariado:</h4>
      <ul className="text-sm text-green-800 space-y-1">
        <li>• Incluye solo experiencias de voluntariado relevantes y significativas</li>
        <li>• Enfócate en el impacto y los resultados obtenidos</li>
        <li>• Menciona habilidades desarrolladas y aplicadas</li>
        <li>• Cuantifica cuando sea posible (personas impactadas, fondos recaudados, etc.)</li>
        <li>• Destaca liderazgo y trabajo en equipo</li>
      </ul>
    </div>
  );
};
